...
// sat
std::pair<std::shared_ptr<arcade::ir::Node>, std::shared_ptr<arcade::ir::VariableManager>> example05() {
    ...
    auto sequence_node = std::make_shared<SequenceNode>(true, children);
